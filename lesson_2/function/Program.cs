Console.Clear();
int a = 0; // создаем переменную a и присваиваем значение 0
a = int.Parse(Console.ReadLine()!); // Ввод числа пользователем и присваивание переменной a вводимого значения с переводом его в числовое значение Parse
